...
from manager_terminator.autogenerated_graphql_client import GetManagersManagersObjectsValidities


def extract_managers_with_no_persons_or_engagements(
    manager_objects: list[GetManagersManagersObjectsValidities],
    ...
    for manager in manager_objects:
        ...
        if employee_data:
            # engagement_org_unit_uuid = None
            for employee in employee_data:
                employee_engagements = employee.engagements
