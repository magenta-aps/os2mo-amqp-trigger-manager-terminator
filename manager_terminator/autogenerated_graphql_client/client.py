...
class GraphQLClient(AsyncBaseClient):
    ...
    async def terminate_manager(
        self, uuid: UUID, termination_date: datetime
    ) -> TerminateManagerManagerTerminate:
        query = gql(
            """
            mutation TerminateManager($uuid: UUID!, $termination_date: DateTime!) {
              manager_terminate(input: {uuid: $uuid, to: $termination_date}) {
                uuid
              }
            }
            """
