...
from manager_terminator.autogenerated_graphql_client.get_engagement_objects_by_uuid import (
    GetEngagementObjectsByUuidEngagementsObjectsValidities,
)
...
async def test_engagement_event_handler():
    ...
    test_data_managers = {
        "objects": [
                ...
                "validities": [
                    {
                        "uuid": uuid.uuid4,
                        "org_unit": [
                            {"uuid": test_data_engagement_objs["objects"][0]["validities"][0]["org_unit"][0]["uuid"]}
                        ],
                        "person": [
                            {
                                "uuid": test_data_engagement_objs["objects"][0]["validities"][0]["person"][0]["uuid"],
                                "engagements": [test_data_engagement_objs["objects"][0]["validities"][0]],
                            }
                        ],
                        "validity": {
                            "from": datetime(2023, 1, 1, 0, 0, 0).replace(tzinfo=DEFAULT_TIMEZONE),
            ...
            },
            {
                "validities": [
                    {
                        "uuid": test_data_engagement_objs["objects"][1]["validities"][0]["org_unit"][0]["uuid"],
                        "org_unit": [{"uuid": uuid.uuid4()}],
                        "person": [
                            {
                                "uuid": test_data_engagement_objs["objects"][1]["validities"][0]["person"][0]["uuid"],
                                "engagements": [test_data_engagement_objs["objects"][1]["validities"][0]],
                            }
                        ],
                        "validity": {
                            "from": datetime(2023, 1, 1, 0, 0, 0).replace(tzinfo=DEFAULT_TIMEZONE),
                ...
                "validities": [
                    {
                        "uuid": uuid.uuid4(),
                        "org_unit": [
                            {"uuid": test_data_engagement_objs["objects"][4]["validities"][0]["org_unit"][0]["uuid"]}
                        ],
                        "person": [
                            {
                                "uuid": test_data_engagement_objs["objects"][4]["validities"][0]["person"][0]["uuid"],
                                "engagements": [test_data_engagement_objs["objects"][4]["validities"][0]],
                            }
                        ],
                        "validity": {
                            "from": datetime(2023, 1, 1, 0, 0, 0).replace(tzinfo=DEFAULT_TIMEZONE),
    ...
    get_employee_managers_mock = AsyncMock(
        return_value=test_data_managers
    )
    ...
    get_employee_managers_mock.assert_has_calls(
        [
            call(
                ...
                list(
                    {
                        test_data_engagement_objs["objects"][0]["validities"][0]["person"][0]["uuid"],
                        test_data_engagement_objs["objects"][1]["validities"][0]["person"][0]["uuid"],
                        test_data_engagement_objs["objects"][2]["validities"][0]["person"][0]["uuid"],
                        test_data_engagement_objs["objects"][4]["validities"][0]["person"][0]["uuid"],
                    }
                )
            )
        ]
    ...
    terminate_manager_mock.assert_has_calls(
        [
            ...
            call(
                ...
                terminate_from=None,
                terminate_to=test_data_engagement_objs["objects"][4]["validities"][0]["validity"]["to"].date(),
            ),
        ]
    )
...
async def test_engagement_event_handler_complex_data():
    ...
    terminate_manager_mock = AsyncMock(
        return_value=test_data_managers[0]["uuid"]
    )
