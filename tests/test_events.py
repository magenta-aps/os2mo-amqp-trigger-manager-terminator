...
async def test_engagement_event_handler():
    ...
    test_data_managers = {
        "objects": [
                        ...
                        "person": [
                            {
                                ...
                                "engagements": [
                                    test_data_engagement_objs["objects"][0][
                                        "validities"
                                    ][0]
                                ],
                            }
            ...
            },
            {
                "validities": [
                    {
                        "uuid": test_data_engagement_objs["objects"][1]["validities"][
                            0
                        ]["org_unit"][0]["uuid"],
                        "org_unit": [{"uuid": uuid.uuid4()}],
                        "person": [
                            {
                                ...
                                "engagements": [
                                    test_data_engagement_objs["objects"][1][
                                        "validities"
                                    ][0]
                                ],
                            }
                        ...
                        "person": [
                            {
                                ...
                                "engagements": [
                                    test_data_engagement_objs["objects"][4][
                                        "validities"
                                    ][0]
                                ],
                            }
    ...
    get_engagement_objects_by_uuids_mock = AsyncMock(
        return_value=test_data_engagement_objs
    )

    get_employee_managers_mock = AsyncMock(return_value=test_data_managers)
...
async def test_engagement_event_handler_complex_data():
    ...
    get_employee_managers_mock = AsyncMock(
        return_value={"objects": [{"validities": test_data_managers}]}
    )

    terminate_manager_mock = AsyncMock(return_value=test_data_managers[0]["uuid"])
