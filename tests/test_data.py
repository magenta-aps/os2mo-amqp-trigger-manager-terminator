            ...
            "validities": [
                {
                    ...
                    "person": [],
                    "validity": {
                        "from_": "1975-12-08T00:00:00+01:00",
                        "to": None,
                    },
                }
            ]
                            ...
                            "engagements": [
                                {
                                    ...
                                    "validity": {
                                        "from": datetime(1975, 12, 8, 0, 0, tzinfo=timezone(timedelta(seconds=3600))),
                                        "to": None
                                    }
                                }
                            ]
                            ...
                            "engagements": [
                                {
                                    ...
                                    "validity": {
                                        "from": datetime(1985, 11, 15, 0, 0, tzinfo=timezone(timedelta(seconds=3600))),
                                        "to": None
                                    }
                                }
                            ]
                            ...
                            "engagements": [
                                {
                                    ...
                                    "validity": {
                                        "from": datetime(1986, 1, 14, 0, 0, tzinfo=timezone(timedelta(seconds=3600))),
                                        "to": None
                                    }
                                }
                            ]
                            ...
                            "engagements": [
                                {
                                    ...
                                    "validity": {
                                        "from": datetime(1965, 1, 4, 0, 0, tzinfo=timezone(timedelta(seconds=3600))),
                                        "to": None
                                    }
                                }
                            ]
                            ...
                            "engagements": [
                                {
                                    ...
                                    "validity": {
                                        "from": datetime(1972, 4, 27, 0, 0, tzinfo=timezone(timedelta(seconds=3600))),
                                        "to": datetime(2023, 9, 18, 0, 0, tzinfo=timezone(timedelta(seconds=7200)))
                                    }
                                },
                                {
                                    "uuid": UUID("fa5e2af6-ae28-4b6b-8895-3b7d39f93d54"),
                                    ...
                                    "validity": {
                                        "from": datetime(2023, 9, 19, 0, 0, tzinfo=timezone(timedelta(seconds=7200))),
                                        "to": None
                                    }
                                }
                            ]
                            ...
                            "engagements": [
                                {
                                    ...
                                    "validity": {
                                        "from": datetime(1968, 8, 16, 0, 0, tzinfo=timezone(timedelta(seconds=3600))),
                                        "to": None
                                    }
                                }
                            ]
                            ...
                            "engagements": [
                                {
                                    ...
                                    "validity": {
                                        "from": datetime(1987, 2, 8, 0, 0, tzinfo=timezone(timedelta(seconds=3600))),
                                        "to": None
                                    }
                                }
                            ]
